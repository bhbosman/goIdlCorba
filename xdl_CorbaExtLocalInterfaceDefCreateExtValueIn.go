...
// Struct declaration: "CORBA::ExtLocalInterfaceDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExtLocalInterfaceDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExtLocalInterfaceDefCreateExtValueInId_Const = "IDL:CORBA/ExtLocalInterfaceDef_create_ext_value_In:1.0"

func (self *CorbaExtLocalInterfaceDefCreateExtValueIn) String() string {
...
func (self *CorbaExtLocalInterfaceDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaExtLocalInterfaceDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExtLocalInterfaceDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExtLocalInterfaceDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExtLocalInterfaceDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExtLocalInterfaceDefCreateExtValueInHelper = CorbaExtLocalInterfaceDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExtLocalInterfaceDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExtLocalInterfaceDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExtLocalInterfaceDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExtLocalInterfaceDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaExtLocalInterfaceDefCreateExtValueIn)(nil))))
}
