...
// Struct declaration: "CORBA::AbstractInterfaceDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaAbstractInterfaceDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaAbstractInterfaceDefCreateExtValueInId_Const = "IDL:CORBA/AbstractInterfaceDef_create_ext_value_In:1.0"

func (self *CorbaAbstractInterfaceDefCreateExtValueIn) String() string {
...
func (self *CorbaAbstractInterfaceDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaAbstractInterfaceDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaAbstractInterfaceDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaAbstractInterfaceDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaAbstractInterfaceDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaAbstractInterfaceDefCreateExtValueInHelper = CorbaAbstractInterfaceDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaAbstractInterfaceDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaAbstractInterfaceDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaAbstractInterfaceDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaAbstractInterfaceDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaAbstractInterfaceDefCreateExtValueIn)(nil))))
}
