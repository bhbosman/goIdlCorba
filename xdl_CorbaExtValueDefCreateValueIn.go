...
// Struct declaration: "CORBA::ExtValueDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExtValueDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExtValueDefCreateValueInId_Const = "IDL:CORBA/ExtValueDef_create_value_In:1.0"

func (self *CorbaExtValueDefCreateValueIn) String() string {
...
func (self *CorbaExtValueDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaExtValueDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExtValueDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExtValueDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExtValueDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExtValueDefCreateValueInHelper = CorbaExtValueDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExtValueDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExtValueDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExtValueDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExtValueDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaExtValueDefCreateValueIn)(nil))))
}
