...
// Struct declaration: "CORBA::ExtAbstractInterfaceDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExtAbstractInterfaceDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExtAbstractInterfaceDefCreateExtValueInId_Const = "IDL:CORBA/ExtAbstractInterfaceDef_create_ext_value_In:1.0"

func (self *CorbaExtAbstractInterfaceDefCreateExtValueIn) String() string {
...
func (self *CorbaExtAbstractInterfaceDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaExtAbstractInterfaceDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExtAbstractInterfaceDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExtAbstractInterfaceDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExtAbstractInterfaceDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExtAbstractInterfaceDefCreateExtValueInHelper = CorbaExtAbstractInterfaceDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExtAbstractInterfaceDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExtAbstractInterfaceDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExtAbstractInterfaceDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExtAbstractInterfaceDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaExtAbstractInterfaceDefCreateExtValueIn)(nil))))
}
