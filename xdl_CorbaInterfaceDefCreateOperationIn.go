...
// Struct declaration: "CORBA::InterfaceDef_create_operation_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaInterfaceDefCreateOperationIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaInterfaceDefCreateOperationInId_Const = "IDL:CORBA/InterfaceDef_create_operation_In:1.0"

func (self *CorbaInterfaceDefCreateOperationIn) String() string {
...
func (self *CorbaInterfaceDefCreateOperationIn) GoString() string {
	return self.String()
}

func (self *CorbaInterfaceDefCreateOperationIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaInterfaceDefCreateOperationIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaInterfaceDefCreateOperationIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaInterfaceDefCreateOperationIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaInterfaceDefCreateOperationInHelper = CorbaInterfaceDefCreateOperationIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaInterfaceDefCreateOperationInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaInterfaceDefCreateOperationIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaInterfaceDefCreateOperationIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaInterfaceDefCreateOperationIn{}
			},
			__reflect__.TypeOf((*CorbaInterfaceDefCreateOperationIn)(nil))))
}
