...
// Struct declaration: "CORBA::ExtValueDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExtValueDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExtValueDefCreateExtValueInId_Const = "IDL:CORBA/ExtValueDef_create_ext_value_In:1.0"

func (self *CorbaExtValueDefCreateExtValueIn) String() string {
...
func (self *CorbaExtValueDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaExtValueDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExtValueDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExtValueDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExtValueDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExtValueDefCreateExtValueInHelper = CorbaExtValueDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExtValueDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExtValueDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExtValueDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExtValueDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaExtValueDefCreateExtValueIn)(nil))))
}
