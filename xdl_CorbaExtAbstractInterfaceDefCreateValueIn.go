...
// Struct declaration: "CORBA::ExtAbstractInterfaceDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExtAbstractInterfaceDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExtAbstractInterfaceDefCreateValueInId_Const = "IDL:CORBA/ExtAbstractInterfaceDef_create_value_In:1.0"

func (self *CorbaExtAbstractInterfaceDefCreateValueIn) String() string {
...
func (self *CorbaExtAbstractInterfaceDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaExtAbstractInterfaceDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExtAbstractInterfaceDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExtAbstractInterfaceDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExtAbstractInterfaceDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExtAbstractInterfaceDefCreateValueInHelper = CorbaExtAbstractInterfaceDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExtAbstractInterfaceDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExtAbstractInterfaceDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExtAbstractInterfaceDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExtAbstractInterfaceDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaExtAbstractInterfaceDefCreateValueIn)(nil))))
}
