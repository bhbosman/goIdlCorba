...
// Struct declaration: "CORBA::Repository_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaRepositoryCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaRepositoryCreateValueInId_Const = "IDL:CORBA/Repository_create_value_In:1.0"

func (self *CorbaRepositoryCreateValueIn) String() string {
...
func (self *CorbaRepositoryCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaRepositoryCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaRepositoryCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaRepositoryCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaRepositoryCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaRepositoryCreateValueInHelper = CorbaRepositoryCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaRepositoryCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaRepositoryCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaRepositoryCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaRepositoryCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaRepositoryCreateValueIn)(nil))))
}
