...
// Struct declaration: "CORBA::Container_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaContainerCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaContainerCreateValueInId_Const = "IDL:CORBA/Container_create_value_In:1.0"

func (self *CorbaContainerCreateValueIn) String() string {
...
func (self *CorbaContainerCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaContainerCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaContainerCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaContainerCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaContainerCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaContainerCreateValueInHelper = CorbaContainerCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaContainerCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaContainerCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaContainerCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaContainerCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaContainerCreateValueIn)(nil))))
}
