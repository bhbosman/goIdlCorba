...
// Struct declaration: "CORBA::LocalInterfaceDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaLocalInterfaceDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaLocalInterfaceDefCreateValueInId_Const = "IDL:CORBA/LocalInterfaceDef_create_value_In:1.0"

func (self *CorbaLocalInterfaceDefCreateValueIn) String() string {
...
func (self *CorbaLocalInterfaceDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaLocalInterfaceDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaLocalInterfaceDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaLocalInterfaceDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaLocalInterfaceDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaLocalInterfaceDefCreateValueInHelper = CorbaLocalInterfaceDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaLocalInterfaceDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaLocalInterfaceDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaLocalInterfaceDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaLocalInterfaceDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaLocalInterfaceDefCreateValueIn)(nil))))
}
