...
// Struct declaration: "CORBA::ExceptionDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExceptionDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExceptionDefCreateValueInId_Const = "IDL:CORBA/ExceptionDef_create_value_In:1.0"

func (self *CorbaExceptionDefCreateValueIn) String() string {
...
func (self *CorbaExceptionDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaExceptionDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExceptionDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExceptionDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExceptionDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExceptionDefCreateValueInHelper = CorbaExceptionDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExceptionDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExceptionDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExceptionDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExceptionDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaExceptionDefCreateValueIn)(nil))))
}
