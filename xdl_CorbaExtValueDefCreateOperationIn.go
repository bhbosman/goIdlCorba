...
// Struct declaration: "CORBA::ExtValueDef_create_operation_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExtValueDefCreateOperationIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExtValueDefCreateOperationInId_Const = "IDL:CORBA/ExtValueDef_create_operation_In:1.0"

func (self *CorbaExtValueDefCreateOperationIn) String() string {
...
func (self *CorbaExtValueDefCreateOperationIn) GoString() string {
	return self.String()
}

func (self *CorbaExtValueDefCreateOperationIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExtValueDefCreateOperationIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExtValueDefCreateOperationIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExtValueDefCreateOperationIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExtValueDefCreateOperationInHelper = CorbaExtValueDefCreateOperationIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExtValueDefCreateOperationInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExtValueDefCreateOperationIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExtValueDefCreateOperationIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExtValueDefCreateOperationIn{}
			},
			__reflect__.TypeOf((*CorbaExtValueDefCreateOperationIn)(nil))))
}
