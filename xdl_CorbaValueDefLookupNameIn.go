...
// Struct declaration: "CORBA::ValueDef_lookup_name_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaValueDefLookupNameIn struct {
	__goidl__.IdlObject
...
const CorbaValueDefLookupNameInId_Const = "IDL:CORBA/ValueDef_lookup_name_In:1.0"

func (self *CorbaValueDefLookupNameIn) String() string {
...
func (self *CorbaValueDefLookupNameIn) GoString() string {
	return self.String()
}

func (self *CorbaValueDefLookupNameIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaValueDefLookupNameIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaValueDefLookupNameIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaValueDefLookupNameIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaValueDefLookupNameInHelper = CorbaValueDefLookupNameIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaValueDefLookupNameInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaValueDefLookupNameIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaValueDefLookupNameIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaValueDefLookupNameIn{}
			},
			__reflect__.TypeOf((*CorbaValueDefLookupNameIn)(nil))))
}
