...
// Struct declaration: "CORBA::ComponentIR::EventDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaComponentIREventDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaComponentIREventDefCreateValueInId_Const = "IDL:CORBA/ComponentIR/EventDef_create_value_In:1.0"

func (self *CorbaComponentIREventDefCreateValueIn) String() string {
...
func (self *CorbaComponentIREventDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaComponentIREventDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaComponentIREventDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaComponentIREventDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaComponentIREventDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaComponentIREventDefCreateValueInHelper = CorbaComponentIREventDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaComponentIREventDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaComponentIREventDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaComponentIREventDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaComponentIREventDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaComponentIREventDefCreateValueIn)(nil))))
}
