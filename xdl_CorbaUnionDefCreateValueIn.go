...
// Struct declaration: "CORBA::UnionDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaUnionDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaUnionDefCreateValueInId_Const = "IDL:CORBA/UnionDef_create_value_In:1.0"

func (self *CorbaUnionDefCreateValueIn) String() string {
...
func (self *CorbaUnionDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaUnionDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaUnionDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaUnionDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaUnionDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaUnionDefCreateValueInHelper = CorbaUnionDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaUnionDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaUnionDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaUnionDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaUnionDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaUnionDefCreateValueIn)(nil))))
}
