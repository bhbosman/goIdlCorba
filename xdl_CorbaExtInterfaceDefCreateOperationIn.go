...
// Struct declaration: "CORBA::ExtInterfaceDef_create_operation_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExtInterfaceDefCreateOperationIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExtInterfaceDefCreateOperationInId_Const = "IDL:CORBA/ExtInterfaceDef_create_operation_In:1.0"

func (self *CorbaExtInterfaceDefCreateOperationIn) String() string {
...
func (self *CorbaExtInterfaceDefCreateOperationIn) GoString() string {
	return self.String()
}

func (self *CorbaExtInterfaceDefCreateOperationIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExtInterfaceDefCreateOperationIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExtInterfaceDefCreateOperationIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExtInterfaceDefCreateOperationIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExtInterfaceDefCreateOperationInHelper = CorbaExtInterfaceDefCreateOperationIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExtInterfaceDefCreateOperationInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExtInterfaceDefCreateOperationIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExtInterfaceDefCreateOperationIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExtInterfaceDefCreateOperationIn{}
			},
			__reflect__.TypeOf((*CorbaExtInterfaceDefCreateOperationIn)(nil))))
}
