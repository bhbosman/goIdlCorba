...
// Struct declaration: "CORBA::Repository_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaRepositoryCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaRepositoryCreateExtValueInId_Const = "IDL:CORBA/Repository_create_ext_value_In:1.0"

func (self *CorbaRepositoryCreateExtValueIn) String() string {
...
func (self *CorbaRepositoryCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaRepositoryCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaRepositoryCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaRepositoryCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaRepositoryCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaRepositoryCreateExtValueInHelper = CorbaRepositoryCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaRepositoryCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaRepositoryCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaRepositoryCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaRepositoryCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaRepositoryCreateExtValueIn)(nil))))
}
