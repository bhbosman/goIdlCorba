...
// Struct declaration: "CORBA::ExtLocalInterfaceDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExtLocalInterfaceDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExtLocalInterfaceDefCreateValueInId_Const = "IDL:CORBA/ExtLocalInterfaceDef_create_value_In:1.0"

func (self *CorbaExtLocalInterfaceDefCreateValueIn) String() string {
...
func (self *CorbaExtLocalInterfaceDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaExtLocalInterfaceDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExtLocalInterfaceDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExtLocalInterfaceDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExtLocalInterfaceDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExtLocalInterfaceDefCreateValueInHelper = CorbaExtLocalInterfaceDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExtLocalInterfaceDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExtLocalInterfaceDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExtLocalInterfaceDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExtLocalInterfaceDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaExtLocalInterfaceDefCreateValueIn)(nil))))
}
