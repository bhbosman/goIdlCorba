...
// Struct declaration: "CORBA::Repository_lookup_name_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaRepositoryLookupNameIn struct {
	__goidl__.IdlObject
...
const CorbaRepositoryLookupNameInId_Const = "IDL:CORBA/Repository_lookup_name_In:1.0"

func (self *CorbaRepositoryLookupNameIn) String() string {
...
func (self *CorbaRepositoryLookupNameIn) GoString() string {
	return self.String()
}

func (self *CorbaRepositoryLookupNameIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaRepositoryLookupNameIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaRepositoryLookupNameIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaRepositoryLookupNameIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaRepositoryLookupNameInHelper = CorbaRepositoryLookupNameIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaRepositoryLookupNameInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaRepositoryLookupNameIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaRepositoryLookupNameIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaRepositoryLookupNameIn{}
			},
			__reflect__.TypeOf((*CorbaRepositoryLookupNameIn)(nil))))
}
