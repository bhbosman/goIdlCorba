...
// Struct declaration: "CORBA::ComponentIR::ModuleDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaComponentIRModuleDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaComponentIRModuleDefCreateValueInId_Const = "IDL:CORBA/ComponentIR/ModuleDef_create_value_In:1.0"

func (self *CorbaComponentIRModuleDefCreateValueIn) String() string {
...
func (self *CorbaComponentIRModuleDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaComponentIRModuleDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaComponentIRModuleDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaComponentIRModuleDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaComponentIRModuleDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaComponentIRModuleDefCreateValueInHelper = CorbaComponentIRModuleDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaComponentIRModuleDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaComponentIRModuleDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaComponentIRModuleDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaComponentIRModuleDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaComponentIRModuleDefCreateValueIn)(nil))))
}
