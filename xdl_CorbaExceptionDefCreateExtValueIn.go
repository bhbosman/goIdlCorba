...
// Struct declaration: "CORBA::ExceptionDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExceptionDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExceptionDefCreateExtValueInId_Const = "IDL:CORBA/ExceptionDef_create_ext_value_In:1.0"

func (self *CorbaExceptionDefCreateExtValueIn) String() string {
...
func (self *CorbaExceptionDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaExceptionDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExceptionDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExceptionDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExceptionDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExceptionDefCreateExtValueInHelper = CorbaExceptionDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExceptionDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExceptionDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExceptionDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExceptionDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaExceptionDefCreateExtValueIn)(nil))))
}
