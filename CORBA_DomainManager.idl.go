...
func (self CorbaDomainManager_Helper) Read(stream IReadAny) (CorbaDomainManager, error) {
	return nil, nil
}

func (self CorbaDomainManager_Helper) Write(stream IWriteAny, v CorbaDomainManager) error {
	return nil
}
...
func (self CorbaConstructionPolicy_Helper) Read(stream IReadAny) (CorbaConstructionPolicy, error) {
	return nil, nil
}

func (self CorbaConstructionPolicy_Helper) Write(stream IWriteAny, v CorbaConstructionPolicy) error {
	return nil
}
...
func (self CorbaDomainManagersList_Helper) Read(stream IReadAny) (CorbaDomainManagersList, error) {
...
func (self CorbaDomainManagersList_Helper) Write(stream IWriteAny, v CorbaDomainManagersList) error {
	if v == nil {
