...
// Struct declaration: "CORBA::ComponentIR::HomeDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaComponentIRHomeDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaComponentIRHomeDefCreateExtValueInId_Const = "IDL:CORBA/ComponentIR/HomeDef_create_ext_value_In:1.0"

func (self *CorbaComponentIRHomeDefCreateExtValueIn) String() string {
...
func (self *CorbaComponentIRHomeDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaComponentIRHomeDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaComponentIRHomeDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaComponentIRHomeDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaComponentIRHomeDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaComponentIRHomeDefCreateExtValueInHelper = CorbaComponentIRHomeDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaComponentIRHomeDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaComponentIRHomeDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaComponentIRHomeDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaComponentIRHomeDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaComponentIRHomeDefCreateExtValueIn)(nil))))
}
