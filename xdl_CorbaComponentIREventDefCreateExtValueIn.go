...
// Struct declaration: "CORBA::ComponentIR::EventDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaComponentIREventDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaComponentIREventDefCreateExtValueInId_Const = "IDL:CORBA/ComponentIR/EventDef_create_ext_value_In:1.0"

func (self *CorbaComponentIREventDefCreateExtValueIn) String() string {
...
func (self *CorbaComponentIREventDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaComponentIREventDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaComponentIREventDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaComponentIREventDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaComponentIREventDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaComponentIREventDefCreateExtValueInHelper = CorbaComponentIREventDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaComponentIREventDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaComponentIREventDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaComponentIREventDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaComponentIREventDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaComponentIREventDefCreateExtValueIn)(nil))))
}
