...
// Struct declaration: "CORBA::ValueDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaValueDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaValueDefCreateExtValueInId_Const = "IDL:CORBA/ValueDef_create_ext_value_In:1.0"

func (self *CorbaValueDefCreateExtValueIn) String() string {
...
func (self *CorbaValueDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaValueDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaValueDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaValueDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaValueDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaValueDefCreateExtValueInHelper = CorbaValueDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaValueDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaValueDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaValueDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaValueDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaValueDefCreateExtValueIn)(nil))))
}
