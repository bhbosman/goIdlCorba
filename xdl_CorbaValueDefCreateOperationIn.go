...
// Struct declaration: "CORBA::ValueDef_create_operation_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaValueDefCreateOperationIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaValueDefCreateOperationInId_Const = "IDL:CORBA/ValueDef_create_operation_In:1.0"

func (self *CorbaValueDefCreateOperationIn) String() string {
...
func (self *CorbaValueDefCreateOperationIn) GoString() string {
	return self.String()
}

func (self *CorbaValueDefCreateOperationIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaValueDefCreateOperationIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaValueDefCreateOperationIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaValueDefCreateOperationIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaValueDefCreateOperationInHelper = CorbaValueDefCreateOperationIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaValueDefCreateOperationInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaValueDefCreateOperationIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaValueDefCreateOperationIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaValueDefCreateOperationIn{}
			},
			__reflect__.TypeOf((*CorbaValueDefCreateOperationIn)(nil))))
}
