...
// Struct declaration: "CORBA::ExtValueDef_create_ext_attribute_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaExtValueDefCreateExtAttributeIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaExtValueDefCreateExtAttributeInId_Const = "IDL:CORBA/ExtValueDef_create_ext_attribute_In:1.0"

func (self *CorbaExtValueDefCreateExtAttributeIn) String() string {
...
func (self *CorbaExtValueDefCreateExtAttributeIn) GoString() string {
	return self.String()
}

func (self *CorbaExtValueDefCreateExtAttributeIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaExtValueDefCreateExtAttributeIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaExtValueDefCreateExtAttributeIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaExtValueDefCreateExtAttributeIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaExtValueDefCreateExtAttributeInHelper = CorbaExtValueDefCreateExtAttributeIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaExtValueDefCreateExtAttributeInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaExtValueDefCreateExtAttributeIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaExtValueDefCreateExtAttributeIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaExtValueDefCreateExtAttributeIn{}
			},
			__reflect__.TypeOf((*CorbaExtValueDefCreateExtAttributeIn)(nil))))
}
