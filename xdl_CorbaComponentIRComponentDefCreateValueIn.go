...
// Struct declaration: "CORBA::ComponentIR::ComponentDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaComponentIRComponentDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaComponentIRComponentDefCreateValueInId_Const = "IDL:CORBA/ComponentIR/ComponentDef_create_value_In:1.0"

func (self *CorbaComponentIRComponentDefCreateValueIn) String() string {
...
func (self *CorbaComponentIRComponentDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaComponentIRComponentDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaComponentIRComponentDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaComponentIRComponentDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaComponentIRComponentDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaComponentIRComponentDefCreateValueInHelper = CorbaComponentIRComponentDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaComponentIRComponentDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaComponentIRComponentDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaComponentIRComponentDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaComponentIRComponentDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaComponentIRComponentDefCreateValueIn)(nil))))
}
