...
// Struct declaration: "CORBA::ComponentIR::ModuleDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaComponentIRModuleDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaComponentIRModuleDefCreateExtValueInId_Const = "IDL:CORBA/ComponentIR/ModuleDef_create_ext_value_In:1.0"

func (self *CorbaComponentIRModuleDefCreateExtValueIn) String() string {
...
func (self *CorbaComponentIRModuleDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaComponentIRModuleDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaComponentIRModuleDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaComponentIRModuleDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaComponentIRModuleDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaComponentIRModuleDefCreateExtValueInHelper = CorbaComponentIRModuleDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaComponentIRModuleDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaComponentIRModuleDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaComponentIRModuleDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaComponentIRModuleDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaComponentIRModuleDefCreateExtValueIn)(nil))))
}
