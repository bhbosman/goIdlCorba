...
// Struct declaration: "CORBA::ComponentIR::Container_create_event_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaComponentIRContainerCreateEventIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaComponentIRContainerCreateEventInId_Const = "IDL:CORBA/ComponentIR/Container_create_event_In:1.0"

func (self *CorbaComponentIRContainerCreateEventIn) String() string {
...
func (self *CorbaComponentIRContainerCreateEventIn) GoString() string {
	return self.String()
}

func (self *CorbaComponentIRContainerCreateEventIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaComponentIRContainerCreateEventIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaComponentIRContainerCreateEventIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaComponentIRContainerCreateEventIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaComponentIRContainerCreateEventInHelper = CorbaComponentIRContainerCreateEventIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaComponentIRContainerCreateEventInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaComponentIRContainerCreateEventIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaComponentIRContainerCreateEventIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaComponentIRContainerCreateEventIn{}
			},
			__reflect__.TypeOf((*CorbaComponentIRContainerCreateEventIn)(nil))))
}
