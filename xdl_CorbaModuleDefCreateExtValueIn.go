...
// Struct declaration: "CORBA::ModuleDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaModuleDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaModuleDefCreateExtValueInId_Const = "IDL:CORBA/ModuleDef_create_ext_value_In:1.0"

func (self *CorbaModuleDefCreateExtValueIn) String() string {
...
func (self *CorbaModuleDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaModuleDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaModuleDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaModuleDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaModuleDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaModuleDefCreateExtValueInHelper = CorbaModuleDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaModuleDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaModuleDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaModuleDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaModuleDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaModuleDefCreateExtValueIn)(nil))))
}
