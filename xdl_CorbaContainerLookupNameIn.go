...
// Struct declaration: "CORBA::Container_lookup_name_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaContainerLookupNameIn struct {
	__goidl__.IdlObject
...
const CorbaContainerLookupNameInId_Const = "IDL:CORBA/Container_lookup_name_In:1.0"

func (self *CorbaContainerLookupNameIn) String() string {
...
func (self *CorbaContainerLookupNameIn) GoString() string {
	return self.String()
}

func (self *CorbaContainerLookupNameIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaContainerLookupNameIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaContainerLookupNameIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaContainerLookupNameIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaContainerLookupNameInHelper = CorbaContainerLookupNameIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaContainerLookupNameInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaContainerLookupNameIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaContainerLookupNameIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaContainerLookupNameIn{}
			},
			__reflect__.TypeOf((*CorbaContainerLookupNameIn)(nil))))
}
