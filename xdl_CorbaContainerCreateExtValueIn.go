...
// Struct declaration: "CORBA::Container_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaContainerCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaContainerCreateExtValueInId_Const = "IDL:CORBA/Container_create_ext_value_In:1.0"

func (self *CorbaContainerCreateExtValueIn) String() string {
...
func (self *CorbaContainerCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaContainerCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaContainerCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaContainerCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaContainerCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaContainerCreateExtValueInHelper = CorbaContainerCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaContainerCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaContainerCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaContainerCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaContainerCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaContainerCreateExtValueIn)(nil))))
}
