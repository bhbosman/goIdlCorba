...
// Struct declaration: "CORBA::LocalInterfaceDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaLocalInterfaceDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaLocalInterfaceDefCreateExtValueInId_Const = "IDL:CORBA/LocalInterfaceDef_create_ext_value_In:1.0"

func (self *CorbaLocalInterfaceDefCreateExtValueIn) String() string {
...
func (self *CorbaLocalInterfaceDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaLocalInterfaceDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaLocalInterfaceDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaLocalInterfaceDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaLocalInterfaceDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaLocalInterfaceDefCreateExtValueInHelper = CorbaLocalInterfaceDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaLocalInterfaceDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaLocalInterfaceDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaLocalInterfaceDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaLocalInterfaceDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaLocalInterfaceDefCreateExtValueIn)(nil))))
}
