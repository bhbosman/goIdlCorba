...
// Struct declaration: "CORBA::InterfaceDef_lookup_name_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaInterfaceDefLookupNameIn struct {
	__goidl__.IdlObject
...
const CorbaInterfaceDefLookupNameInId_Const = "IDL:CORBA/InterfaceDef_lookup_name_In:1.0"

func (self *CorbaInterfaceDefLookupNameIn) String() string {
...
func (self *CorbaInterfaceDefLookupNameIn) GoString() string {
	return self.String()
}

func (self *CorbaInterfaceDefLookupNameIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaInterfaceDefLookupNameIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaInterfaceDefLookupNameIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaInterfaceDefLookupNameIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaInterfaceDefLookupNameInHelper = CorbaInterfaceDefLookupNameIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaInterfaceDefLookupNameInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaInterfaceDefLookupNameIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaInterfaceDefLookupNameIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaInterfaceDefLookupNameIn{}
			},
			__reflect__.TypeOf((*CorbaInterfaceDefLookupNameIn)(nil))))
}
