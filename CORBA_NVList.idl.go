...
type CorbaNVList interface {
	...
	AddItem(ItemName CorbaIdentifier, ItemType CorbaTypeCode, Value CorbaOpaqueValue, ValueLen int32, ItemFlags uint32) (error error)
	// Original name: "free"
	Free() (error error)
...
func (self CorbaNVList_Helper) Read(stream IReadAny) (CorbaNVList, error) {
	return nil, nil
}

func (self CorbaNVList_Helper) Write(stream IWriteAny, v CorbaNVList) error {
	return nil
}
