...
// Struct declaration: "CORBA::UnionDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaUnionDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaUnionDefCreateExtValueInId_Const = "IDL:CORBA/UnionDef_create_ext_value_In:1.0"

func (self *CorbaUnionDefCreateExtValueIn) String() string {
...
func (self *CorbaUnionDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaUnionDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaUnionDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaUnionDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaUnionDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaUnionDefCreateExtValueInHelper = CorbaUnionDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaUnionDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaUnionDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaUnionDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaUnionDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaUnionDefCreateExtValueIn)(nil))))
}
