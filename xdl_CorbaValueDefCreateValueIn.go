...
// Struct declaration: "CORBA::ValueDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaValueDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaValueDefCreateValueInId_Const = "IDL:CORBA/ValueDef_create_value_In:1.0"

func (self *CorbaValueDefCreateValueIn) String() string {
...
func (self *CorbaValueDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaValueDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaValueDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaValueDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaValueDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaValueDefCreateValueInHelper = CorbaValueDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaValueDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaValueDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaValueDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaValueDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaValueDefCreateValueIn)(nil))))
}
