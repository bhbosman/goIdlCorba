...
// Struct declaration: "CORBA::StructDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaStructDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaStructDefCreateValueInId_Const = "IDL:CORBA/StructDef_create_value_In:1.0"

func (self *CorbaStructDefCreateValueIn) String() string {
...
func (self *CorbaStructDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaStructDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaStructDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaStructDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaStructDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaStructDefCreateValueInHelper = CorbaStructDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaStructDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaStructDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaStructDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaStructDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaStructDefCreateValueIn)(nil))))
}
