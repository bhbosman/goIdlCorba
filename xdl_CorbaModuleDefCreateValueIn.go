...
// Struct declaration: "CORBA::ModuleDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaModuleDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaModuleDefCreateValueInId_Const = "IDL:CORBA/ModuleDef_create_value_In:1.0"

func (self *CorbaModuleDefCreateValueIn) String() string {
...
func (self *CorbaModuleDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaModuleDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaModuleDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaModuleDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaModuleDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaModuleDefCreateValueInHelper = CorbaModuleDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaModuleDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaModuleDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaModuleDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaModuleDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaModuleDefCreateValueIn)(nil))))
}
