...
// Struct declaration: "CORBA::InterfaceDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaInterfaceDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaInterfaceDefCreateExtValueInId_Const = "IDL:CORBA/InterfaceDef_create_ext_value_In:1.0"

func (self *CorbaInterfaceDefCreateExtValueIn) String() string {
...
func (self *CorbaInterfaceDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaInterfaceDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaInterfaceDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaInterfaceDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaInterfaceDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaInterfaceDefCreateExtValueInHelper = CorbaInterfaceDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaInterfaceDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaInterfaceDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaInterfaceDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaInterfaceDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaInterfaceDefCreateExtValueIn)(nil))))
}
