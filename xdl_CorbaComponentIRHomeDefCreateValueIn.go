...
// Struct declaration: "CORBA::ComponentIR::HomeDef_create_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaComponentIRHomeDefCreateValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaComponentIRHomeDefCreateValueInId_Const = "IDL:CORBA/ComponentIR/HomeDef_create_value_In:1.0"

func (self *CorbaComponentIRHomeDefCreateValueIn) String() string {
...
func (self *CorbaComponentIRHomeDefCreateValueIn) GoString() string {
	return self.String()
}

func (self *CorbaComponentIRHomeDefCreateValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaComponentIRHomeDefCreateValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaComponentIRHomeDefCreateValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaComponentIRHomeDefCreateValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaComponentIRHomeDefCreateValueInHelper = CorbaComponentIRHomeDefCreateValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaComponentIRHomeDefCreateValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaComponentIRHomeDefCreateValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaComponentIRHomeDefCreateValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaComponentIRHomeDefCreateValueIn{}
			},
			__reflect__.TypeOf((*CorbaComponentIRHomeDefCreateValueIn)(nil))))
}
