...
// Struct declaration: "CORBA::StructDef_create_ext_value_In", generatedBy by: "WriteStructDcl"
// Exception Decl: false
type CorbaStructDefCreateExtValueIn struct {
	__goidl__.IdlObject
	Id string `json:"Id"`
...
const CorbaStructDefCreateExtValueInId_Const = "IDL:CORBA/StructDef_create_ext_value_In:1.0"

func (self *CorbaStructDefCreateExtValueIn) String() string {
...
func (self *CorbaStructDefCreateExtValueIn) GoString() string {
	return self.String()
}

func (self *CorbaStructDefCreateExtValueIn) ReadValue(stream __goidl__.IReadAny) error {
	var err error
...
func (self *CorbaStructDefCreateExtValueIn) Read(stream __goidl__.IReadAny) error {
...
func (self *CorbaStructDefCreateExtValueIn) Write(stream __goidl__.IWriteAny) error {
	var err error
...
//noinspection GoSnakeCaseUsage
type CorbaStructDefCreateExtValueIn_Helper struct {
}


//noinspection GoUnusedGlobalVariable
var CorbaStructDefCreateExtValueInHelper = CorbaStructDefCreateExtValueIn_Helper{}

func init() {
	__goidl__.AddRegistration(
		__goidl__.NewRegistrationInformation(
			CorbaStructDefCreateExtValueInId_Const,
			__goidl__.StructType,
			"CORBA_InterfaceRepository.idl",
			"xdl_CorbaStructDefCreateExtValueIn.go",
			func() __goidl__.IIdlObject {
				return &CorbaStructDefCreateExtValueIn{}
			},
			func(generator __goidl__.IRandomDataGenerator) __goidl__.IIdlObject {
				return &CorbaStructDefCreateExtValueIn{}
			},
			__reflect__.TypeOf((*CorbaStructDefCreateExtValueIn)(nil))))
}
